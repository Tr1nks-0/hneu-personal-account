...
<div class="content-wrapper">
    <div class="content">
        ...
        <ol class="breadcrumb panel panel-default">
            ...
            <li class="active"><spring:message code="form.label.management.import.disciplines"/></li>
        </ol>
        ...
        <div class="panel panel-default">
            <div class="panel-heading">
                <div class="row">
                    <div class="col-md-12">
                        <spring:message code="form.label.management.import.disciplines"/>
                    </div>
                </div>
            </div>
            <div class="panel-body">
                <form method="post" action="/management/import/disciplines" enctype="multipart/form-data">
